...
LANGS["EN"] = {
    ...
    "toc": ["System Overview", "VPS Deployment", "Object Installation", "Client Interface", "Multiple Cabinets", "Updating", "Troubleshooting"],
...
LANGS["RU"] = {
    ...
    "toc": ["Обзор системы", "Развёртывание VPS", "Установка на объект", "Клиентский интерфейс", "Несколько кабинетов", "Обновление", "Диагностика"],
...
LANGS["AZ"] = {
    ...
    "toc": ["Sistem icmalı", "VPS quraşdırması", "Obyektə quraşdırma", "Klient interfeysi", "Çoxlu kabinetlər", "Yeniləmə", "Diaqnostika"],
...
def build_pdf(lang, data):
    ...
    try:
        ...
        section_keys = ["s1", "s2", "s3", "s4", "s5", "s6", "s7"]
        page_map = {}
